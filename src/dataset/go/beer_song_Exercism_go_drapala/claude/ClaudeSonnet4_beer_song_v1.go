...
func nBottles(n int) string {
	...
	var builder strings.Builder
	builder.Grow(60) // Pre-allocate approximate capacity
...
func nTakedown(n int) string {
	...
	var builder strings.Builder
	builder.Grow(80) // Pre-allocate approximate capacity
...
// Simple integer to string conversion for small positive numbers
