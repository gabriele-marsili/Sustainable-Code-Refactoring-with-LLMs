...
func SplitNum(n int64) NumStruct {
	...
	remainderAfterBillions := n % 1000000000
	millions := remainderAfterBillions / 1000000
	remainderAfterMillions := remainderAfterBillions % 1000000
	thousands := remainderAfterMillions / 1000
	hundreds := remainderAfterMillions % 1000
