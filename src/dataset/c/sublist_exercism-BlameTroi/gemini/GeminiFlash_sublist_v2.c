...
static bool containedIn(const int *left, size_t nLeft, const int *right, size_t nRight) {
    if (nLeft > nRight) {
        return false;
    }
...
comparison_result_t check_lists(const int *compareList, const int *baseList, size_t nCompareList, size_t nBaseList) {
