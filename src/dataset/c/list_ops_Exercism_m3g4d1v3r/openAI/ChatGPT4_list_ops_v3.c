...
list_t *append_list(list_t *list1, list_t *list2) {
    ...
    if (len1 > 0) memcpy(result->elements, list1->elements, sizeof(list_element_t) * len1);
    if (len2 > 0) memcpy(result->elements + len1, list2->elements, sizeof(list_element_t) * len2);
