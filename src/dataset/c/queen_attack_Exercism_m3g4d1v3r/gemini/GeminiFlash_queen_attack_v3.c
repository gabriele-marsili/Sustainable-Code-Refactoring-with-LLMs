...
bool same_diagonal(position_t queen_1, position_t queen_2) {
    uint8_t delta_row = (queen_1.row > queen_2.row) ? (queen_1.row - queen_2.row) : (queen_2.row - queen_1.row);
    uint8_t delta_column = (queen_1.column > queen_2.column) ? (queen_1.column - queen_2.column) : (queen_2.column - queen_1.column);
...
attack_status_t can_attack(position_t queen_1, position_t queen_2) {
    ...
    if (queen_1.row == queen_2.row || queen_1.column == queen_2.column ||
        ((queen_1.row > queen_2.row) ? (queen_1.row - queen_2.row) : (queen_2.row - queen_1.row)) ==
        ((queen_1.column > queen_2.column) ? (queen_1.column - queen_2.column) : (queen_2.column - queen_1.column))) {
        return CAN_ATTACK;
    }
