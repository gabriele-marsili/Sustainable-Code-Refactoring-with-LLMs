...
inline bool validate_position(position_t queen) {
    return queen.row < BOARD_1D && queen.column < BOARD_1D;
}

inline bool same_row(position_t queen_1, position_t queen_2) {
    return queen_1.row == queen_2.row;
}

inline bool same_column(position_t queen_1, position_t queen_2) {
    return queen_1.column == queen_2.column;
}

inline bool same_diagonal(position_t queen_1, position_t queen_2) {
    const int delta_row = queen_1.row - queen_2.row;
    const int delta_column = queen_1.column - queen_2.column;
