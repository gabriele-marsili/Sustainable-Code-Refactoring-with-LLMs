...
{
    const space_age age(1000000000);
...
{
    const space_age age(2134835688);
...
{
    const space_age age(2329871239);
...
{
    const space_age age(3000000000);
...
{
    const space_age age(3210123456);
...
{
    const space_age age(8210123456);
