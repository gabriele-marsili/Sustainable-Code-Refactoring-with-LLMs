...
int main() {
    ...
    cout << "Sum of even numbers: " << sum_of_even(numbers) << endl;
    cout << "Maximum element: " << find_maximum(numbers) << endl;

    vector<int> positive_numbers = filter_positive(numbers);
    ...
    cout << "Number of primes: " << count_primes(numbers) << endl;
