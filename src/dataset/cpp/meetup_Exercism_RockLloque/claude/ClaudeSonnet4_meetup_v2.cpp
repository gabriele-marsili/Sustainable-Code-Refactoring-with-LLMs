...
namespace meetup
{
	...
	{
		return nth_day(boost::date_time::weekdays::Monday, 4);
	}

	boost::gregorian::date scheduler::fourth_tuesday() const
	{
		return nth_day(boost::date_time::weekdays::Tuesday, 4);
	}

	boost::gregorian::date scheduler::fourth_wednesday() const
	{
		return nth_day(boost::date_time::weekdays::Wednesday, 4);
	}

	boost::gregorian::date scheduler::fourth_thursday() const
	{
		return nth_day(boost::date_time::weekdays::Thursday, 4);
	}

	boost::gregorian::date scheduler::fourth_friday() const
	{
		return nth_day(boost::date_time::weekdays::Friday, 4);
	}

	boost::gregorian::date scheduler::fourth_saturday() const
	{
		return nth_day(boost::date_time::weekdays::Saturday, 4);
	}

	boost::gregorian::date scheduler::fourth_sunday() const
	{
		return nth_day(boost::date_time::weekdays::Sunday, 4);
	}
