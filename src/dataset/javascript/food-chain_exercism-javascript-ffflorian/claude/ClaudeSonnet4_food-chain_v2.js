...
export class Song {
  constructor() {
     ...
     * @type {string[]}
     */
    this._cachedVerses = new Array(this._verses.length);
  }
  ...
  verse(index) {
    ...
    if (this._cachedVerses[cacheIndex]) {
      return this._cachedVerses[cacheIndex];
    }

    const currentVerse = this._verses[cacheIndex];
    ...
    this._cachedVerses[cacheIndex] = parts.join('');
    return this._cachedVerses[cacheIndex];
  }
