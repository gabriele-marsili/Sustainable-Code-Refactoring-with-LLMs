...
describe('House', () => {
    it('verse one - the house that jack built', () => {
        ...
        expect((0, house_1.verse)(1)).toEqual(lyrics);
    });
    xit('verse two - the malt that lay', () => {
        ...
        expect((0, house_1.verse)(2)).toEqual(lyrics);
    });
    xit('verse three - the rat that ate', () => {
        ...
        expect((0, house_1.verse)(3)).toEqual(lyrics);
    });
    xit('verse four - the cat that killed', () => {
        ...
        expect((0, house_1.verse)(4)).toEqual(lyrics);
    });
    xit('verse five - the dog that worried', () => {
        ...
        expect((0, house_1.verse)(5)).toEqual(lyrics);
    });
    xit('verse six - the cow with the crumpled horn', () => {
        ...
        expect((0, house_1.verse)(6)).toEqual(lyrics);
    });
    xit('verse seven - the maiden all forlorn', () => {
        ...
        expect((0, house_1.verse)(7)).toEqual(lyrics);
    });
    xit('verse eight - the man all tattered and torn', () => {
        ...
        expect((0, house_1.verse)(8)).toEqual(lyrics);
    });
    xit('verse nine - the priest all shaven and shorn', () => {
        ...
        expect((0, house_1.verse)(9)).toEqual(lyrics);
    });
    xit('verse ten - the rooster that crowed in the morn', () => {
        ...
        expect((0, house_1.verse)(10)).toEqual(lyrics);
    });
    xit('verse eleven - the farmer sowing his corn', () => {
        ...
        expect((0, house_1.verse)(11)).toEqual(lyrics);
    });
    xit('verse twelve - the horse and the hound and the horn', () => {
        ...
        expect((0, house_1.verse)(12)).toEqual(lyrics);
    });
    xit('multiple verses', () => {
        const startVerse = 4;
        const endVerse = 8;
        ...
        expect((0, house_1.verses)(startVerse, endVerse)).toEqual(lyrics);
    });
    xit('full rhyme', () => {
        const startVerse = 1;
        const endVerse = 12;
