...
describe('words()', () => {
    ...
    it('includes numbers', () => {
        ...
        expect((0, word_count_1.count)('1 2 testing testing')).toEqual(expectedCounts);
    });
    it('normalizes to lower case', () => {
        const expectedCounts = new Map(Object.entries({ go: 3 }));
        expect((0, word_count_1.count)('go Go GO')).toEqual(expectedCounts);
    });
    it('counts properly international characters', () => {
        const expectedCounts = new Map(Object.entries({ '¡hola!': 1, '¿qué': 1, 'tal?': 1, 'привет!': 1 }));
        expect((0, word_count_1.count)('¡Hola! ¿Qué tal? Привет!')).toEqual(expectedCounts);
    });
    it('counts multiline', () => {
        const expectedCounts = new Map(Object.entries({ hello: 1, world: 1 }));
        expect((0, word_count_1.count)('hello\nworld')).toEqual(expectedCounts);
    });
    it('counts tabs', () => {
        const expectedCounts = new Map(Object.entries({ hello: 1, world: 1 }));
        expect((0, word_count_1.count)('hello\tworld')).toEqual(expectedCounts);
    });
    ...
    it('does not count leading or trailing whitespace', () => {
        ...
        expect((0, word_count_1.count)('\t\tIntroductory Course      ')).toEqual(expectedCounts);
    });
