...
describe('BinarySearchTree', () => {
    it('should retain data', () => {
        expect(new binary_search_tree_1.BinarySearchTree(4).data).toEqual(4);
    });
    xit('should insert a lesser number to the left', () => {
        const four = new binary_search_tree_1.BinarySearchTree(4);
        four.insert(2);
    ...
    xit('should iterate over one element', () => {
        expect(recordAllData(new binary_search_tree_1.BinarySearchTree(4))).toEqual([4]);
    });
