...
const wordy_1 = require("./wordy");
describe('Word Problem', () => {
    it('add 1', () => {
        const question = 'What is 1 plus 1?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(2);
    });
    it('add 2', () => {
        const question = 'What is 53 plus 2?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(55);
    });
    it('add negative numbers', () => {
        const question = 'What is -1 plus -10?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(-11);
    });
    it('add more digits', () => {
        const question = 'What is 123 plus 45678?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(45801);
    });
    it('subtract', () => {
        const question = 'What is 4 minus -12?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(16);
    });
    it('multiply', () => {
        const question = 'What is -3 multiplied by 25?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(-75);
    });
    it('divide', () => {
    ...
    it('add twice', () => {
        ...
        expect(new wordy_1.WordProblem(question).answer()).toEqual(3);
    });
    it('add then subtract', () => {
        const question = 'What is 1 plus 5 minus -2?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(8);
    });
    it('subtract twice', () => {
    ...
    it('subtract then add', () => {
        ...
        expect(new wordy_1.WordProblem(question).answer()).toEqual(14);
    });
    it('multiply twice', () => {
        const question = 'What is 2 multiplied by -2 multiplied by 3?';
        expect(new wordy_1.WordProblem(question).answer()).toEqual(-12);
    });
    ...
    it('too advanced', () => {
        ...
        const problem = new wordy_1.WordProblem(question);
        expect(problem.answer.bind(problem)).toThrowError(wordy_1.ArgumentError);
    });
    it('irrelevant', () => {
