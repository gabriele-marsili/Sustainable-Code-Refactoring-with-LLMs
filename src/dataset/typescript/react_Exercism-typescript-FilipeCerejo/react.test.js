...
describe('React module', () => {
    ...
    xit('compute cells can depend on other compute cells', () => {
        const [input, setInput] = (0, react_1.createInput)(1);
        const timesTwo = (0, react_1.createComputed)(() => input() * 2);
        const timesThirty = (0, react_1.createComputed)(() => input() * 30);
        const sum = (0, react_1.createComputed)(() => timesTwo() + timesThirty());
    ...
    xit('compute cells fire callbacks', () => {
        ...
        const output = (0, react_1.createComputed)(() => input() + 1);
        let value = 0;
        (0, react_1.createCallback)(() => (value = output()));
        setInput(3);
    ...
    xit('callbacks fire only when output values change', () => {
        const [input, setInput] = (0, react_1.createInput)(1);
        const output = (0, react_1.createComputed)(() => (input() < 3 ? 111 : 222), undefined, true // i.e. equality check - don't propagate if value doesn't change
        );
        let value;
        (0, react_1.createCallback)(() => (value = output()));
    ...
    xit('callbacks can fire from multiple cells', () => {
        const [input, setInput] = (0, react_1.createInput)(1);
        const plus_one = (0, react_1.createComputed)(() => input() + 1);
        const minus_one = (0, react_1.createComputed)(() => input() - 1);
        let value1 = 0;
        (0, react_1.createCallback)(() => (value1 = plus_one()));
        let value2 = 0;
        (0, react_1.createCallback)(() => (value2 = minus_one()));
        setInput(10);
    ...
    xit('callbacks can be added and removed', () => {
        const [input, setInput] = (0, react_1.createInput)(11);
        const output = (0, react_1.createComputed)(() => input() + 1);
        const values1 = [];
        const unsubscribe1 = (0, react_1.createCallback)(() => values1.push(output()));
        values1.pop(); // discard initial value from registration
        const values2 = [];
        (0, react_1.createCallback)(() => values2.push(output()));
        values2.pop(); // discard initial value ...
        setInput(31);
        unsubscribe1();
        const values3 = [];
        (0, react_1.createCallback)(() => values3.push(output()));
    ...
    xit('callbacks should only be called once, even if multiple dependencies change', () => {
        const [input, setInput] = (0, react_1.createInput)(1);
        const plusOne = (0, react_1.createComputed)(() => input() + 1);
        const minusOne1 = (0, react_1.createComputed)(() => input() - 1);
        const minusOne2 = (0, react_1.createComputed)(() => minusOne1() - 1);
        const output = (0, react_1.createComputed)(() => plusOne() * minusOne2());
        const values = [];
        (0, react_1.createCallback)(() => values.push(output()));
        values.pop(); // discard initial value from registration
        setInput(4);
    ...
    xit("callbacks should not be called if dependencies change but output value doesn't change", () => {
        const [input, setInput] = (0, react_1.createInput)(1);
        const plusOne = (0, react_1.createComputed)(() => input() + 1);
        const minusOne = (0, react_1.createComputed)(() => input() - 1);
        const alwaysTwo = (0, react_1.createComputed)(() => plusOne() - minusOne(), undefined, true // i.e. equality check - don't propagate if value doesn't change
        );
        const values = [];
        (0, react_1.createCallback)(() => values.push(alwaysTwo()));
        values.pop(); // discard initial value from registration
        setInput(2);
        setInput(3);
        setInput(4);
