...
`;
        expect((0, beer_song_1.sing)(8, 6)).toEqual(expected);
    });
...
Go to the store and buy some more, 99 bottles of beer on the wall.
`;
        expect((0, beer_song_1.sing)(3)).toEqual(expected);
    });
    xit('sings all the verses', () => {
        const song = (0, beer_song_1.sing)();
