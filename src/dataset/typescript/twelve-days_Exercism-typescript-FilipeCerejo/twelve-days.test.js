...
describe('verse', () => {
    it('first day a partridge in a pear tree', () => {
        ...
        expect((0, twelve_days_1.recite)(1, 1)).toEqual(expected);
    });
    xit('second day two turtle doves', () => {
        ...
        expect((0, twelve_days_1.recite)(2, 2)).toEqual(expected);
    });
    xit('third day three french hens', () => {
        ...
        expect((0, twelve_days_1.recite)(3, 3)).toEqual(expected);
    });
    xit('fourth day four calling birds', () => {
        ...
        expect((0, twelve_days_1.recite)(4, 4)).toEqual(expected);
    });
    xit('fifth day five gold rings', () => {
        ...
        expect((0, twelve_days_1.recite)(5, 5)).toEqual(expected);
    });
    xit('sixth day six geese-a-laying', () => {
        ...
        expect((0, twelve_days_1.recite)(6, 6)).toEqual(expected);
    });
    xit('seventh day seven swans-a-swimming', () => {
        ...
        expect((0, twelve_days_1.recite)(7, 7)).toEqual(expected);
    });
    xit('eighth day eight maids-a-milking', () => {
        ...
        expect((0, twelve_days_1.recite)(8, 8)).toEqual(expected);
    });
    xit('ninth day nine ladies dancing', () => {
        ...
        expect((0, twelve_days_1.recite)(9, 9)).toEqual(expected);
    });
    xit('tenth day ten lords-a-leaping', () => {
        ...
        expect((0, twelve_days_1.recite)(10, 10)).toEqual(expected);
    });
    xit('eleventh day eleven pipers piping', () => {
        ...
        expect((0, twelve_days_1.recite)(11, 11)).toEqual(expected);
    });
...
describe('lyrics', () => {
    ...
    xit('recites the whole song', () => {
        ...
        expect((0, twelve_days_1.recite)(1, 12)).toEqual(expected);
    });
});
