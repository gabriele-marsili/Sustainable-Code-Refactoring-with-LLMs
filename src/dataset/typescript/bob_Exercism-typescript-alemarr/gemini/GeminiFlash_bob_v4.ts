...
const isEmpty = (trimmedMessage: string) => {
  return trimmedMessage === "";
};

const isYell = (trimmedMessage: string, upperTrimmedMessage: string) => {
  ...
  return (
    upperTrimmedMessage === trimmedMessage && /[A-Z]/.test(trimmedMessage)
  );
};

const isQuestion = (trimmedMessage: string) => {
