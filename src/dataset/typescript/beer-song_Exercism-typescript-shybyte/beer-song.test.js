...
`;
        expect(beer_song_1.default.sing(8, 6)).toEqual(expected);
    });
...
Go to the store and buy some more, 99 bottles of beer on the wall.
`;
        expect(beer_song_1.default.sing(3)).toEqual(expected);
    });
    it('sings all the verses', () => {
        const song = beer_song_1.default.sing();
