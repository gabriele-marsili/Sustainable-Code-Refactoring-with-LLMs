...
const kindergarten_garden_1 = require("./kindergarten-garden");
describe('partial Garden', () => {
    it('garden with single student', () => {
        expect(new kindergarten_garden_1.Garden('RC\nGG').plants('Alice')).toEqual([
            'radishes',
            'clover',
            'grass',
            'grass',
    ...
    xit('different garden with single student', () => {
        expect(new kindergarten_garden_1.Garden('VC\nRC').plants('Alice')).toEqual([
            'violets',
            'clover',
            'radishes',
            'clover',
    ...
    xit('garden with two students', () => {
        expect(new kindergarten_garden_1.Garden('VVCG\nVVRC').plants('Bob')).toEqual([
            'clover',
            'grass',
            'radishes',
            'clover',
    ...
    describe('multiple students for the same garden with three students', () => {
        xit("second student's garden", () => {
            expect(new kindergarten_garden_1.Garden('VVCCGG\nVVCCGG').plants('Bob')).toEqual([
                'clover',
                'clover',
                'clover',
                'clover',
...
describe('full garden', () => {
    ...
    const garden = new kindergarten_garden_1.Garden(diagram);
...
describe('disordered class', () => {
    ...
    const garden = new kindergarten_garden_1.Garden(diagram, students);
    xit('for Patricia', () => {
...
describe('Two gardens, different students', () => {
    const diagram = 'VCRRGVRG\nRVGCCGCV';
    const garden1 = new kindergarten_garden_1.Garden(diagram, ['Alice', 'Bob', 'Charlie', 'Dan']);
    const garden2 = new kindergarten_garden_1.Garden(diagram, ['Bob', 'Charlie', 'Dan', 'Erin']);
