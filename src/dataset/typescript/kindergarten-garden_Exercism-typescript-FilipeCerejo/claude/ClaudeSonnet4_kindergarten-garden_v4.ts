...
export class Garden {
  ...
  public plants(student: Student): Plants {
    ...
    return [
      PLANT_CODES[row0[firstPlantIdx] as keyof typeof PLANT_CODES],
      PLANT_CODES[row0[firstPlantIdx + 1] as keyof typeof PLANT_CODES],
      PLANT_CODES[row1[firstPlantIdx] as keyof typeof PLANT_CODES],
      PLANT_CODES[row1[firstPlantIdx + 1] as keyof typeof PLANT_CODES],
    ];
  }
}