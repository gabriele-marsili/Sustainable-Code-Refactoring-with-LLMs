class Node<T> {
  constructor(
    private _value: T,
    private _previous: Node<T> | undefined = undefined,
    private _next: Node<T> | undefined = undefined
  ) {}
...
export class LinkedList<T> {
  private _first: Node<T> | undefined = undefined;
  private _last: Node<T> | undefined = undefined;
  private _size: number = 0;

  public push(value: T): void {
    const newNode = new Node<T>(value, this._last);
    if (this._last) {
  ...
  public unshift(value: T): void {
    const newNode = new Node<T>(value, undefined, this._first);
    if (this._first) {
