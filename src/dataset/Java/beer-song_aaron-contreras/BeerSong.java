public class BeerSong {
    ...
    public String sing(int beers, int amountTaken) {
        ...
        while (beers > finalVerse) {
            switch (beers) {
                case 0 -> builder.append("No more bottles of beer on the wall, no more bottles of beer.\n")
                        .append("Go to the store and buy some more, 99 bottles of beer on the wall.\n\n");
                case 1 -> builder.append("1 bottle of beer on the wall, 1 bottle of beer.\n")
                        .append("Take it down and pass it around, no more bottles of beer on the wall.\n\n");
                default -> builder.append(beers).append(" bottles of beer on the wall, ").append(beers)
