public class SalaryCalculator {
    ...
    public double salaryMultiplier(int daysSkipped) {
        return (daysSkipped > MAX_SKIPPED_DAYS_WITHOUT_PENALTY) ? (1.0 - SKIPPED_DAYS_PENALTY) : 1.0;
    }
    ...
    public double bonusForProductsSold(int productsSold) {
        int bonus = (productsSold >= MIN_SOLD_FOR_EXTRA_BONUS) ? EXTRA_BONUS : BASIC_BONUS;
        return productsSold * bonus;
    }
