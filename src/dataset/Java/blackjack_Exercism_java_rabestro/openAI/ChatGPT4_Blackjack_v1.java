public class Blackjack {
    ...
    static {
        ...
        CARD_VALUES['2'] = 2;  // two
        CARD_VALUES['3'] = 3;  // three
        CARD_VALUES['4'] = 4;  // four
        CARD_VALUES['5'] = 5;  // five
        CARD_VALUES['6'] = 6;  // six
        CARD_VALUES['7'] = 7;  // seven
        CARD_VALUES['8'] = 8;  // eight
        CARD_VALUES['9'] = 9;  // nine
    }

    public int parseCard(String card) {
        return card == null || card.isEmpty() ? 0 : CARD_VALUES[card.charAt(0)];
    }
