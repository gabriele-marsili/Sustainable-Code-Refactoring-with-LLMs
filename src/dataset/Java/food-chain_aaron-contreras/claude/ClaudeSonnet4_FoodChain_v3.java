public class FoodChain {
    ...
    private static final String CATCH_FORMAT = "She swallowed the %s to catch the %s.\n";
    private static final String SPIDER_CATCH = "She swallowed the spider to catch the fly.\n";
    ...
    public String verse(int verseNumber) {
        switch (verseNumber) {
            ...
            default:
                ...
                builder.append(String.format(INTRO_FORMAT, INTRO_ANIMALS[verseNumber - 3]));
                
                for (int i = verseNumber - 1; i > 0; i--) {
                    if (i == 1) {
                        builder.append(SPIDER_CATCH);
                    } else {
                        builder.append(String.format(CATCH_FORMAT, ANIMALS[i], ANIMALS[i - 1]));
                    }
                }
