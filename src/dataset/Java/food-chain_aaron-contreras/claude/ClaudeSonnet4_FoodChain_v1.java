public class FoodChain {
    ...
    private static final String SPIDER_CATCH_FLY = "She swallowed the spider to catch the fly.\n";
    ...
    public String verse(int verseNumber) {
        switch (verseNumber) {
            ...
            default:
                ...
                builder.append(String.format(INTRO, INTRO_ANIMALS[verseNumber - 3]));
                
                for (int i = verseNumber - 1; i > 1; i--) {
                    builder.append("She swallowed the ")
                           .append(ANIMALS[i])
                           .append(" to catch the ")
                           .append(ANIMALS[i - 1])
                           .append(".\n");
                ...
                builder.append(SPIDER_CATCH_FLY)
                       .append(LAST_VERSE);
    ...
    public String verses(int verseA, int verseB) {
        StringBuilder builder = new StringBuilder((verseB - verseA + 1) * 200);
