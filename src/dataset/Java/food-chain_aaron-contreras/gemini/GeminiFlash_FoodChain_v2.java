public class FoodChain {
    ...
    private static final String SHE_SWALLOWED = "She swallowed the %s to catch the %s.\n";
    private static final String I_KNOW = "I know an old lady who swallowed a ";
    ...
    public String verse(int verseNumber) {
        switch (verseNumber) {
            ...
            default:
                ...
                builder.append(I_KNOW).append(INTRO_ANIMALS[verseNumber - 2]);

                for (int i = verseNumber - 1; i > 0; i--) {
                    if (i != 1) {
                        builder.append(String.format(SHE_SWALLOWED, ANIMALS[i], ANIMALS[i - 1]));
                    } else {
