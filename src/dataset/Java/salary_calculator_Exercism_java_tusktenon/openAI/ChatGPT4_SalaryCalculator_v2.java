public class SalaryCalculator {
  ...
  public double finalSalary(int daysSkipped, int productsSold) {
    int bonusMultiplier = productsSold >= IMPROVED_BONUS_MINIMUM_PRODUCTS 
                          ? IMPROVED_BONUS_MULTIPLIER 
                          : BASE_BONUS_MULTIPLIER;
    double calculatedSalary = BASE_SALARY * salaryMultiplier(daysSkipped) + (productsSold * bonusMultiplier);
