public class SalaryCalculator {
  ...
  private static final int IMPROVED_BONUS_MIN_PRODUCTS = 20;
  ...
  public int bonusMultiplier(int productsSold) {
    return productsSold < IMPROVED_BONUS_MIN_PRODUCTS ? BASE_BONUS_MULTIPLIER : IMPROVED_BONUS_MULTIPLIER;
  }

  public double bonusForProductsSold(int productsSold) {
    return productsSold * (productsSold < IMPROVED_BONUS_MIN_PRODUCTS ? BASE_BONUS_MULTIPLIER : IMPROVED_BONUS_MULTIPLIER);
  }
