public class SalaryCalculator {
  ...
  public int bonusMultiplier(int productsSold) {
    return productsSold < IMPROVED_BONUS_MINIMUM_PRODUCTS ? BASE_BONUS_MULTIPLIER : IMPROVED_BONUS_MULTIPLIER;
  }

  public double bonusForProductsSold(int productsSold) {
    return productsSold * (productsSold < IMPROVED_BONUS_MINIMUM_PRODUCTS ? BASE_BONUS_MULTIPLIER : IMPROVED_BONUS_MULTIPLIER);
  }
