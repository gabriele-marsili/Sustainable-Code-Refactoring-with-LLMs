class RnaTranscription {
  ...
  String transcribe(String dnaStrand) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (dnaChar >= transcriptionMap.length || transcriptionMap[dnaChar] == 0) {
        throw new IllegalArgumentException("Invalid nucleotide character: " + dnaChar);
      }
      rnaStrand.append(transcriptionMap[dnaChar]);
    }
