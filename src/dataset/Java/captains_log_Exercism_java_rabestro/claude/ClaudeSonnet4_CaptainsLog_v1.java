...
class CaptainsLog {
    ...
    private static final double STARDATE_MULTIPLIER = 1000.0;
    ...
    String randomShipRegistryNumber() {
        return String.format("NCC-%04d", SHIP_REGISTRY_MIN + random.nextInt(SHIP_REGISTRY_RANGE));
    }

    double randomStardate() {
        return STARDATE_BASE + STARDATE_MULTIPLIER * random.nextDouble();
    }
}