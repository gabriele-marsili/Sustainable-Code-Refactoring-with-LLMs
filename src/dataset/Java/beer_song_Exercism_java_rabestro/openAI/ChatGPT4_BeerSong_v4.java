class BeerSong {
    ...
    public String sing(int count, int repeat) {
        StringBuilder song = new StringBuilder(repeat * 150); // Pre-allocate estimated capacity
        while (repeat-- > 0) {
            if (count == 0) {
                ...
                String bottleCount = bottle(count);
                song.append(bottleCount).append(" of beer on the wall, ")
                    .append(bottleCount).append(" of beer.\n")
