...
from dataset_handling.datasetCreator import CodeTestDatasetCreator
from dataset_handling.clusterCreator import ClusterCreator
from utility_dir import utility_paths
from adjustments_and_fixes.general_adjustments import adjusPaths, adjust_licenses, adjustMetadata
from utility_dir.general_utils import load_github_token, setup_github_token
...
if __name__ == "__main__":
    ...
    if args.adjust_licenses : 
        adjust_licenses()
    if args.adjust_paths : 
        adjusPaths()
    if args.create_focused_cluster : 
